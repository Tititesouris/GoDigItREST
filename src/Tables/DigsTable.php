...
class DigsTable
{
    ...
    public static function getDig($id) {
        return array(
            (new DigModel($id, 2, 3, 5, "Test", "dsadasdsadada", 0))->toArray()
        );
    }

    public static function addDig(DigModel $dig) {
        return (new DigModel($dig->getId(), $dig->getLat(), $dig->getLong(), $dig->getAlt(), $dig->getName(), $dig->getQrcode(), $dig->getBudget()))->toArray();
    }
    ...
    public static function removeDig($id) {
        return (new DigModel($id, null, null, null, null, null, null))->toArray();
    }
